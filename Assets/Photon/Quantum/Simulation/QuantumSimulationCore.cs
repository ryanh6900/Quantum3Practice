...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public sealed override void Free(bool freeSharedResources) {
      _globals->ClearPointers(this, default);
      FreeUser();
      FreeGen();
      base.Free(freeSharedResources);
    }
...
namespace Quantum {
  ...
  /// <summary>
  /// Does not have to implemement checksum, because it's a hard-coded synced event.
  /// </summary>
...
namespace Quantum {
  ...
  /// A Quantum callback is a incovation from inside the simulation during certain situations.
  /// </summary>
  public class CallbackDispatcher : DispatcherBase, Quantum.ICallbackDispatcher {
    ...
    /// <summary>
    /// Contructor calls <see cref="GetBuiltInTypes"/>.
    /// </summary>
    public CallbackDispatcher() : base(GetBuiltInTypes()) { }
    /// <summary>
    /// Contructor to add the callback type mapping manually.
    /// </summary>
...
namespace Quantum {
  ...
  /// in reponse to a checksum error.
  /// </summary>
  public unsafe partial class ChecksumErrorFrameDumpContext {
    ...
    /// <summary>
    /// Serialize the addtional meta data.
    /// </summary>
    /// <param name="game">Game</param>
  ...
  public unsafe partial class QuantumGame : IDeterministicGame {
    ...
    public QuantumGame(in QuantumGameStartParameters startParams) {
      ...
      if (startParams.InitialDynamicAssets != null) {
        _initialDynamicAssets = new DynamicAssetDB(startParams.InitialDynamicAssets.Allocator);
    ...
    public IDisposable CreateFrameContext() {
      if (_context == null) {
        ...
        args.IsLegacyDynamicDBModeEnabled = (_flags & QuantumGameFlags.EnableLegacyDynamicDBMode) == QuantumGameFlags.EnableLegacyDynamicDBMode;
    ...
    /// <param name="checksum">The checkum that will be send to the server</param>
...
namespace Quantum {
  ...
  public enum CallbackId {
    ...
    PlayerAddConfirmed,
    /// <summary>
    /// Callback when a local player was successully removed from the game.
    /// </summary>
  ...
  public sealed class CallbackGameInit : QuantumGame.CallbackBase {
    ...
    /// <summary>
    /// Is set to true if the game was re-synchronized.
    /// </summary>
  ...
  public sealed class CallbackChecksumErrorFrameDump : QuantumGame.CallbackBase {
    ...
    /// <summary>
    /// Deserialize the runtime config.
    /// </summary>
    public RuntimeConfig RuntimeConfig {
      get {
    ...
    /// <summary>
    /// Deserialize the frame dunmp context.
    /// </summary>
...
namespace Quantum {
  ...
  public partial class QuantumGameFlags {
    ...
    /// <summary>
    /// Enable the legacy dynamic DB mode. See <see cref="DynamicAssetDB.IsLegacyModeEnabled"/> for more information.
    /// </summary>
    public const int EnableLegacyDynamicDBMode = 1 << 4;
    /// <summary>
...
namespace Quantum {
  ...
  /// <summary>
  /// This input provider can store a certain amout of input sets in a ring buffer.
  /// </summary>
...
namespace Quantum {
  ...
  public class StreamReplayInputProvider : IDeterministicStreamReplayInputProvider {
    ...
    /// <summary>
    /// Skip to a slected frame in the stream.
    /// </summary>
...
namespace Quantum {
  ...
  /// This implementation of the <see cref="IRunnerFactory"/> is not unsed in Unity but in 
